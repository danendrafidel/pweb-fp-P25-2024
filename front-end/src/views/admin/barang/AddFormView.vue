                ...
                <div class="flex flex-row justify-between">
                    <div class="mb-4">
                        ...
                        <input v-model="amount"
                            ...
                            id="amount" type="number" placeholder="1" min="1">
                    </div>
                    <div class="mb-4 w-2/4">
                        <label class="block text-gray-700 text-sm font-bold mb-2" for="role">
                            Kondisi
                        </label>
                        <select class=" min-w-36 bg-slate-50 p-2 border border-gray-300 rounded"
                            id="condition" name="condition" v-model="selectedCondition">
                            <option>Baik</option>
                            <option>Rusak</option>
                        </select>
                    </div>
