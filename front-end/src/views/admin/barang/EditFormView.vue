...
<template>
    <main>
        <div class="w-2/4 mx-auto py-10">
            <form @submit.prevent="handleFormSubmit" class="bg-white shadow-md rounded px-8 py-10">
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        id="name" type="text" placeholder="Nama Barang" v-model="name">
                </div>
                <div class="flex flex-row justify-between">
                    <div class="mb-4">
                        ...
                        <input v-model="amount"
                            ...
                            id="amount" type="number" placeholder="1" min="1" value="">
                    </div>
                    <div class="mb-4 w-2/4">
                        <label class="block text-gray-700 text-sm font-bold mb-2" for="role">
                            Kondisi
                        </label>
                        <select class=" min-w-36 bg-slate-50 p-2 border border-gray-300 rounded" id="condition"
                            name="condition" v-model="selectedCondition">
                            <option>Baik</option>
                            <option>Rusak</option>
                        </select>
                    </div>
                </div>
                <p v-if="errorMessage" class="text-red-500 text-sm italic pb-2">{{ errorMessage }}</p>
