        ...
        >
          ...
          <tbody>
            <tr v-for="(i, index) in operators" :key="i._id">
              ...
              <td
                class="px-4 max-w-24 min-w-16 py-1 border border-slate-300 space-x-3"
              >
                <button
                  @click="
                    navigateToEditOperator(
                      i._id,
                      i.username,
                      i.password,
                      i.role
                  ...
                  "
                  class="bg-yellow-500 text-white py-1 px-5 rounded-md"
                >
                  Edit
                </button>
                <button
                  @click="confirmDelete(i._id)"
                  class="bg-red-500 text-white py-1 px-5 rounded-md"
                >
                  Delete
                </button>
              </td>
